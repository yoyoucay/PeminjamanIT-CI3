...
class Admin_models extends CI_Model
{
    ...
    public function updAkunById($id, $newData)
    {
        // Update data in your database table
        // Example SQL update query
        $this->db->where('idUser', $id);
        $this->db->update('tb_user', $newData);
    ...
    public function updPengajuan($id, $newData)
    {
        // Update data in your database table
        // Example SQL update query
    ...
    public function deleteAkunById($id)
    {
        // Delete data from your database table
        // Example SQL delete query
        $this->db->where('idUser', $id);
    ...
    public function get_datatablesAkun()
    {
    ...
    public function _get_datatables_Akun()
    {
        // Query Datatables for Part

        $column_order = array(null, 'sEmpID', 'sFullname', 'sRole');
        $column_search = array('sEmpID', 'sFullname', 'sRole');
    ...
    {
        $this->_get_datatables_Pengajuan();
        if ($_POST["length"] != -1)
            $this->db->limit($_POST['length'], $_POST['start']);
    ...
    public function _get_datatables_Pengajuan()
    {
        // Query Datatables for Part
