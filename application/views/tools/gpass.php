...
<div class="flex">
    <div class="w-full">
        <section class="p-2 flex flex-col break-words bg-white sm:border-1 sm:rounded-md sm:shadow-sm sm:shadow-lg">
            <?= form_open('gpass', array('class' => 'w-full px-6 py-6 space-y-3 sm:px-5 sm:space-y-4')) ?>
                ...
                <div class="flex flex-wrap py-4">
                    <button type="submit" name="btnGenerate" class="w-full select-none font-bold whitespace-no-wrap p-3 rounded-lg text-base leading-normal no-underline text-gray-100 bg-blue-500 hover:bg-blue-700 sm:py-4">
                        Generate
                    </button>
                </div>
            <?= form_close(); ?>
